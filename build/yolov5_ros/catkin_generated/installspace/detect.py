...
class Yolov5Detector:
    def __init__(self):
        ...
        self.distance_x_pub = rospy.Publisher("yolo_center_x", Float32, queue_size=1)
        self.distance_y_pub = rospy.Publisher("yolo_center_y", Float32, queue_size=1)
        ...
        input_image_type, input_image_topic, _ = get_topic_type(rospy.get_param("~input_image_topic", "/DIDALOS_vtol/usb_cam/image_raw"), blocking = True)
    ...
    def callback(self, data):
        ...
        if len(det):
            ...
            for *xyxy, conf, cls in reversed(det):
                ...
                self.distance_x_pub.publish(Float32(center_x))  
                self.distance_y_pub.publish(Float32(center_y)) 
